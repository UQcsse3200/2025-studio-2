...
public class StatisticsScreen extends ScreenAdapter {
    ...
    private final String[] statsMenuSounds = {
    ...
    public StatisticsScreen(GdxGame game) {
        ...
        logger.debug("Initialising statistics screen");
    ...
    private void loadAssets() {
        ...
        resourceService.loadSounds(statsMenuSounds);
    ...
    private void unloadAssets() {
        ...
        resourceService.unloadAssets(statsMenuSounds);
    }
    ...
    private void createUI() {
        ...
        ui.addComponent(new StatisticsDisplay(game))
                .addComponent(new InputDecorator(stage, 10))
                .addComponent(new StatisticsInputComponent(this))
                .addComponent(new StatisticsActions(game));
