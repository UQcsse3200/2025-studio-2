 ...
 */
public class SelfDestructionDroneAnimation extends Component {
...
//    private final GameTime timeSource = ServiceLocator.getTimeSource();
    ...
    public void create() {
        ...
        entity.getEvents().addListener("flyingStart", this::animateflying);
        entity.getEvents().addListener("selfDestructStart", this::animateselfDestrct);
    }
    ...
    void animateselfDestrct() {
        setAnimation("self_destruct");
    }
    /**
