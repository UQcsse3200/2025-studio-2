...
public class WorldTextureTestGameArea extends GameArea {
    private static final Logger logger = LoggerFactory.getLogger(WorldTextureTestGameArea.class);
    ...
    private static final String[] gameTextures = {
        ...
        "images/cavelevel/platformcentretile.png",
        "images/cavelevel/platformendtile.png"
    };
    ...
    /**
     * Initialise this test game area to use the provided TerrainFactory.
     * @param terrainFactory TerrainFactory used to create the terrain for the GameArea.
     * @requires terrainFactory != null
     */
    public WorldTextureTestGameArea(TerrainFactory terrainFactory) {
        super();
    ...
    private void displayUI() {
        ...
        ui.addComponent(new GameAreaDisplay("textures testing level"));
    ...
    private void spawnTerrain() {
        // Background terrain
        terrain = terrainFactory.createTerrain(TerrainType.TEXTURE_TEST);
