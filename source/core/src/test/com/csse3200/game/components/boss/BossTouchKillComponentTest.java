...
class BossTouchKillComponentTest {
    @BeforeEach
    void beforeEach() {
        ...
        // Load required assets for ExplosionFactory
        ResourceService resourceService = ServiceLocator.getResourceService();
        resourceService.loadTextureAtlases(new String[]{"images/explosion.atlas"}); // or whatever atlas is needed
    ...
    Entity createAttacker(short targetLayer) {
        Entity entity =
                new Entity()
                        .addComponent(new BossTouchKillComponent(targetLayer))
