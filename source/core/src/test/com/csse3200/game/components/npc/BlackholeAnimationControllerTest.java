...
class BlackholeAnimationControllerTest {
    ...
    private BlackholeAnimationController controller;

    @BeforeEach
    void setUp() {
        Gdx.app = app;
        controller = new BlackholeAnimationController();
        controller.setEntity(entity);
    }

    @Test
    void shouldStartBlackHoleAnimationOnCreate() {
        when(entity.getComponent(AnimationRenderComponent.class)).thenReturn(animator);

        controller.create();

        verify(animator).startAnimation("touchKillEffect");
    }
